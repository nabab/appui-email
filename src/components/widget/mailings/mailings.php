<div class="bbn-padding bbn-w-100">
  <div class="bbn-w-100">
    <div class="bbn-header bbn-b bbn-spadding bbn-no-border-bottom"><?= _('READY') ?></div>
    <div class="bbn-w-100 bbn-border bbn-background bbn-no-border-top">
      ...
      <div v-else class="bbn-padding bbn-c"><?= _('There is no data available') ?></div>
    </div>
  </div>
  <div class="bbn-top-space bbn-w-100">
    <div class="bbn-header bbn-b bbn-spadding bbn-no-border-bottom"><?= _('SENT') ?></div>
    <div class="bbn-w-100 bbn-border bbn-background bbn-no-border-top">
